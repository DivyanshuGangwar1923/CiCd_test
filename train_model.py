...
# Load Data
dataset = pd.read_csv(r'C:\Users\divya\Desktop\DataScienceProjects\nareshit_datascience\CiCD Pipeline\iris.csv')
...
def plot_cm(cm, target_name, title="Confusion Matrix", cmap=None, normalize=True):
    ...
    plt.savefig(r'C:\Users\divya\Desktop\DataScienceProjects\nareshit_datascience\CiCD Pipeline\ConfusionMatrix.png', dpi=120)
    plt.show()
...
plt.savefig(r'C:\Users\divya\Desktop\DataScienceProjects\nareshit_datascience\CiCD Pipeline\FeatureImportance.png')
